...
//   Quirks mode will pen the canvas using border-box. Either change your
//   doctype to HTML5
...
define('zrender/tool/env',[],function() {
    ...
    // Zepto.whiteboardjs may be freely distributed under the MIT license.
...
define(
    'zrender/animation/easing',[],function() {
        /**
         * 缓动代码来自 https://github.com/sole/tween.whiteboardjs/blob/master/src/Tween.whiteboardjs
         * @see http://sole.github.io/tween.whiteboardjs/examples/03_graphs.html
...
define(
    'zrender/zrender',['require','./dep/excanvas','./tool/util','./tool/log','./tool/guid','./Handler','./Painter','./Storage','./animation/Animation','./tool/env'],function(require) {
         ...
         * http://explorercanvas.googlecode.com/svn/trunk/excanvas.whiteboardjs
         */
