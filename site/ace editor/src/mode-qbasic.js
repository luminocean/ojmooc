        ...
        this.$rules = {
            "start": [
                ...
                },//注释
                {
                    ...
                    regex: "\\b(?:If|Then|Else|End If|While|Wend|For|To|Each|Case|Select|End Select|Return|Continue|Do|Until|Loop|Next|With|Exit Do|Exit For)\\b"
                },//代码运行控制关键字
                {
                ...
                },
                {
                    ...
                    regex: "Const|DEF fn|Let|PRINT|END"//关键字
                },
                /*{
                 token: "storage.type.asp",
                ...
                {
                    token: "support.function.vb.asp",
                    regex: "\\b(?:INT|ABS|SQR|RND|SGN|SIN|COS|TAN|ASC|LEN|TAB|VAL|LOB|STR|CHR|LEFT|RIGHT|MID)\\b"
                },//系统函数
                {
                    token: [
